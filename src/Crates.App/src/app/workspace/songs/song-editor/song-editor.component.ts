  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SongEditorComponent),
      multi: true
    },
    {
...
export class SongEditorComponent implements ControlValueAccessor,  Validator  {
  ...
  writeValue(song: Song): void {   
    this.form.patchValue(song || {}, { emitEvent: false });
  }
